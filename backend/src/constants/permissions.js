 ...
 * 
 * Constants are now loaded from database via permissionService
 * Import from '../services/permission.service.js' instead
 * 
 * Usage:
 *   import { ROLES, PERMISSIONS } from '../services/permission.service.js';
 * 
 * Or:
...
export { ROLES, PERMISSIONS, PERMISSION_MATRIX } from '../services/permission.service.js';

/**
 * @deprecated Use permissionService.ROLES instead
...
/**
 * @deprecated Use permissionService.PERMISSIONS instead
...
/**
 * @deprecated Use permissionService.getPermissionMatrix() instead
