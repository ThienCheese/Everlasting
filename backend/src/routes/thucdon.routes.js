...
// CRUD thực đơn
router.post('/create', authMiddleware, requireAdmin, createLimiter, validateCreateThucDon, auditLogger('THUCDON_CREATE'), createThucDon);
...
router.post('/:id/monan', authMiddleware, requireAdmin, validateIdParam('id'), validateAddMonAn, auditLogger('THUCDON_ADD_MONAN'), addMonAnThucDon);
