...
router.post('/:id/dichvu', authMiddleware, requirePermission('QUAN_LY_DAT_TIEC'), bookingLimiter, validateIdParam('id'), validateAddDichVu, auditLogger('DATTIEC_ADD_DICHVU'), addDichVuDatTiec);
